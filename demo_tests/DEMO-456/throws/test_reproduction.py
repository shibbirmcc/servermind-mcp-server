"""
Reproduction tests for ticket DEMO-456
Service: throws
...
class TestBugReproduction:
    """Test class for reproducing the bug described in DEMO-456."""
    ...
    def test_reproduce_original_bug(self):
        ...
        Bug Analysis: Payment service throws NullPointerException when processing credit card payments. This happens intermittently, about 5% of the time. Stack trace shows the error occurs in PaymentValidator.validateCard() method.
        Root Cause: 
        """
        ...
        expected_errors = ['occurs in PaymentValidator.validateCard() method.', 'when processing credit card payments. This happens intermittently, about 5% of the time. Stack trace shows the error occurs in PaymentValidator.validateCard() method.']
...
class TestDataFactory:
    ...
    def create_test_scenario_data():
        ...
        return {
            ...
            "bug_context": {
                "analysis": "Payment service throws NullPointerException when processing credit card payments. This happens intermittently, about 5% of the time. Stack trace shows the error occurs in PaymentValidator.validateCard() method.",
                "root_cause": "",
                "error_patterns": ['occurs in PaymentValidator.validateCard() method.', 'when processing credit card payments. This happens intermittently, about 5% of the time. Stack trace shows the error occurs in PaymentValidator.validateCard() method.']
            }
        }
